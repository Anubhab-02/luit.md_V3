...
function addLink() {
    const myTextarea = document.getElementById('textarea');
    myTextarea.value += '[Text](https://)';
}
function addImage() {
    const myTextarea = document.getElementById('textarea');
    myTextarea.value += `<img src='' style='width:100%'>`;
}
function addNote() {
...
function addLight() {
    ...
    var text1 = '<mark>';
    var text2 = '</mark>';
    textarea.value = textarea.value.substring(0, start) + text1 + textarea.value.substring(start, end) + text2 + textarea.value.substring(end);
}
